void Sequencer(){
  ...
  //exploratory midi clock output. . . .
  if( MIDI_CLOCK_ON == 0) MIDI.write(250);
  // if(main_index == 0) MIDI.write(250);
  // if(main_index == 0) MIDI.write(252);
   else MIDI.write(248);
      ...
      if(cur_index % getDivide(0,i) == 0) {
        ...
        if(val[i] > 0) {
          if(1){
            ...
            //scheduleMidiEvent( nifty.DRUM_ON, nifty.drum[i], 0, gate_length); 
