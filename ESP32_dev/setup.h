//LCD Display
Mini_LiquidCrystal_I2C lcd(0x3F,16,4);  // set the LCD address to 0x27 for a 16 chars and 2 line display
...
//MIDI output
HardwareSerial MIDI(1);  //if using UART1
