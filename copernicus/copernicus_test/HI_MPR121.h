...
enum {
  ...
  MPR121_GPIO_CTL0 = 0x73,
  MPR121_GPIO_CTL1 = 0x74,
...
//    HI_MPR121(byte _SDA, byte _SCL);
    ...
    void proxChargeTime(byte val);
     ...
     void enableGPIO(byte num, byte state);
     void setGPIO(byte num, byte state);
     void updateGPIO();
     void disableGPIO(byte num);

     void monitorCapSettings();
